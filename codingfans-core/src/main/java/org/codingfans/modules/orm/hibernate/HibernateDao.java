...
import org.codingfans.modules.orm.ExtSimpleDao;
 ...
 * 
 */
public class HibernateDao<T, PK extends Serializable> extends SimpleHibernateDao<T, PK> implements ExtSimpleDao<T>
{
    /**
     * 用于Dao层子类的构造函数.
